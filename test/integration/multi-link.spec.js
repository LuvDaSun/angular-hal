...
describe("special attribute names", function() {
  ...
  it("should be able to handle multiple links", function() {
    $httpBackend.expect("GET", "/").respond({
      _links: {
        self: "/",
        multiString: ["/link/string1", "/link/string2"],
        multiObject: {
          href: ["/link/object1{?query}", "/link/object2{?query}"],
          templated: true
        },
        multiArray: [
          {
    ...
    $httpBackend.expect("GET", "/link/array1").respond({});
    $httpBackend.expect("GET", "/link/array2").respond({});
