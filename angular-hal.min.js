...
!function(n,e,r){"use strict";function l(n,l,u,a){function t(n,l){var u=this;return function(){e(u,{uriReference:n,linkParams:angular.merge({rel:null,anchor:null,rev:null,hreflang:null,media:null,title:null,type:null},l)})}(),u.toString=function(){var n="<"+u.uriReference+">",e=[];return r(u.linkParams,function(n,r){n&&e.push(r+'="'+n+'"')}),e.length<1?n:n=n+";"+e.join(";")},this}return t}n.factory("LinkHeader",l),l.$inject=["$q","$extendReadOnly","$injector","$halConfiguration"]}(angular.module("angular-hal.client"),angular.merge,angular.forEach);
...
!function(a){"use strict";a.module("angular-hal",["angular-hal.url-generator","angular-hal.http-interception","angular-hal.client","ng"])}(angular);