...
=======
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function HalResourceClientFactory(e,r,n,t){function u(u,i){function l(r,l,a,o,d){var f;if(r=r||"GET",l=l||n.selfLink,a=a||{},o=o||null,d=d||{},"GET"===r&&l===n.selfLink)return e.resolve(u);if(u.$hasEmbedded(l)&&Array.isArray(i[l])){f=[];for(var s=0;s<i[l].length;s++)f.push(i[l][s].$request().$request(r,"self",a,o,d));return e.all(f)}if(u.$hasEmbedded(l))return i[l].$request().$request(r,"self",a,o,d);if(u.$hasLink(l)){var $=u.$href(l,a);if(angular.extend(d,{method:r,data:o}),Array.isArray($)){f=[];for(var c=0;c<$.length;c++)f.push(x(angular.extend({},d,{url:$[c]})));return e.all(f)}return x(angular.extend({},d,{url:u.$href(l,a)}))}var h=new Error('link "'+l+'" is undefined');return t.error(h),e.reject(h)}function a(e,r,n){return l("GET",e,r,void 0,n)}function o(e,r,n){return a(e,r,n).then(function(r){return r.$hasEmbedded(e)?r.$request().$get(e):[]})}function d(e,r,n,t){return l("POST",e,r,n,t)}function f(e,r,n,t){return l("PUT",e,r,n,t)}function s(e,r,n,t){return l("PATCH",e,r,n,t)}function $(e,r,n){return l("DELETE",e,r,void 0,n)}function c(e,r,n,t){return t=t||{},t.headers=t.headers||{},t.headers.Link=n.map(p),l("LINK",e,r,void 0,t)}function h(e,r,n,t){return t=t||{},t.headers=t.headers||{},t.headers.Link=n.map(p),l("UNLINK",e,r,void 0,t)}function p(e){return e.toString()}function y(e,r){return x(angular.extend({},r,{method:"GET",url:u.$href(n.selfLink,e)}))}function g(e,r){return $(n.selfLink,e,r)}function v(e,r,t){return f(n.selfLink,e,r,t)}var k=this,x=r.get("$http");!function(){(0,_extendReadOnly2["default"])(k,{$request:l,$get:a,$getCollection:o,$post:d,$put:f,$patch:s,$delete:$,$del:$,$link:c,$unlink:h,$reloadSelf:y,$putSelf:v,$deleteSelf:g})}()}return u}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=HalResourceClientFactory;var _extendReadOnly=require("../utility/extend-read-only"),_extendReadOnly2=_interopRequireDefault(_extendReadOnly);HalResourceClientFactory.$inject=["$q","$injector","$halConfiguration","$log"];
>>>>>>> 678c1df... Move shortcuts in request
