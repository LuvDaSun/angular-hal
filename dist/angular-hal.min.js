...
"use strict";function ResourceHttpInterceptorFactory(e,t){function r(e){return void 0===e.headers.Accept?e.headers.Accept=CONTENT_TYPE:e.headers.Accept=[CONTENT_TYPE,e.headers.Accept].join(", "),e}function n(t){try{if((0,_contentType.parse)(t.headers("Content-Type")).type===CONTENT_TYPE)return o(t)}catch(e){}return t.config.forceHal?o(t):"application/json"!==t.headers("Content-Type")&&null!==t.headers("Content-Type")||!e.forceJSONResource?t:o(t)}function o(e){return e.data=new t(e.data,e),e}return{request:r,response:n}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=ResourceHttpInterceptorFactory;var _contentType=require("content-type"),CONTENT_TYPE="application/hal+json";ResourceHttpInterceptorFactory.$inject=["$halConfiguration","Resource"];
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function HalResourceClientFactory(e,n,t){function r(r,u){function l(n,l,i,a,f){var o;if(n=n||"GET",l=l||t.selfLink,i=i||{},a=a||null,f=f||{},"GET"===n&&l===t.selfLink)return e.resolve(r);if(r.$hasEmbedded(l)&&Array.isArray(u[l])){o=[];for(var d=0;d<u[l].length;d++)o.push(u[l][d].$request().$request(n,"self",i,a,f));return e.all(o)}if(r.$hasEmbedded(l))return u[l].$request().$request(n,"self",i,a,f);if(r.$hasLink(l)){var s=r.$href(l,i);if(angular.extend(f,{method:n,data:a}),Array.isArray(s)){o=[];for(var c=0;c<s.length;c++)o.push(S(angular.extend({},f,{url:s[c]})));var $=o.map(function(e){return e.then(function(e){return e.data})});return e.all($)}return q(l,i,f)}return e.reject(new Error('link "'+l+'" is undefined'))}function i(e,n,t){return l("GET",e,n,void 0,t)}function a(e,n,t){return i(e,n,t).then(function(n){return n.$has(e)?n.$request().$get(e):[]})}function f(e,n,t,r){return l("POST",e,n,t,r)}function o(e,n,t,r){return l("PUT",e,n,t,r)}function d(e,n,t,r){return l("PATCH",e,n,t,r)}function s(e,n,t){return l("DELETE",e,n,void 0,t)}function c(e,n,t,r){return r=r||{},r.headers=r.headers||{},r.headers.Link=t.map(h),l("LINK",e,n,void 0,r)}function $(e,n,t,r){return r=r||{},r.headers=r.headers||{},r.headers.Link=t.map(h),l("UNLINK",e,n,void 0,r)}function h(e){return e.toString()}function k(e){var n=angular.extend({},e,{method:"GET"});return q(t.selfLink,{},n)}function p(e,n){return o(t.selfLink,null,e,n)}function L(e,n){return f(t.selfLink,null,e,n)}function v(e,n){return d(t.selfLink,null,e,n)}function y(e,n){return c(t.selfLink,null,e,n)}function g(e,n){return $(t.selfLink,null,e,n)}function x(e){return s(t.selfLink,null,e)}function q(e,n,t){return S(angular.extend({},t,{url:r.$href(e,n)})).then(function(e){return e.data})}var E=this,S=n.get("$http");!function(){(0,_extendReadOnly2.default)(E,{$request:l,$get:i,$getCollection:a,$post:f,$put:o,$patch:d,$delete:s,$del:s,$link:c,$unlink:$,$getSelf:k,$postSelf:L,$putSelf:p,$patchSelf:v,$deleteSelf:x,$delSelf:x,$linkSelf:y,$unlinkSelf:g})}()}return r}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=HalResourceClientFactory;var _extendReadOnly=require("../utility/extend-read-only"),_extendReadOnly2=_interopRequireDefault(_extendReadOnly);HalResourceClientFactory.$inject=["$q","$injector","$halConfiguration"];
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function ResourceFactory(e,t,r){function n(i,o){function u(){for(var e in i)i.hasOwnProperty(e)&&(c(e)||(0,_defineReadOnly2.default)(g,e,i[e]))}function f(){"object"===_typeof(i[t.linksAttribute])&&Object.keys(i[t.linksAttribute]).forEach(function(e){var r=i[t.linksAttribute][e];k[e]=(0,_normalizeLink2.default)(o.config.url,r)})}function a(){"object"===_typeof(i[t.embeddedAttribute])&&Object.keys(i[t.embeddedAttribute]).forEach(function(e){d(e,i[t.embeddedAttribute][e])})}function l(){R=new e(g,A)}function d(e,t){if(Array.isArray(t))return A[e]=[],void t.forEach(function(t){A[e].push(new n(t,o))});A[e]=new n(t,o)}function c(e){for(var r=0;r<t.ignoreAttributePrefixes.length;r++){if(e.substr(0,1)===t.ignoreAttributePrefixes[r])return!0;if(e===t.linksAttribute||e===t.embeddedAttribute)return!0}return!1}function s(e){return void 0!==k[e]}function y(e){return void 0!==A[e]}function b(e){return s(e)||y(e)}function p(e,r){var n=_(e),i=n.href;if(Array.isArray(n)){i=[];for(var o=0;o<n.length;o++){var u=n[o],f=u.href;void 0!==u.templated&&u.templated&&(f=(0,_generateUrl2.default)(u.href,r)),f=t.urlTransformer(f),i.push(f)}}else void 0!==n.templated&&n.templated&&(i=(0,_generateUrl2.default)(n.href,r)),i=t.urlTransformer(i);return i}function _(e){if(!s(e))throw new Error('link "'+e+'" is undefined');var t=k[e];return void 0!==t.deprecation&&r.warn('The link "'+e+'" is marked as deprecated with the value "'+t.deprecation+'".'),t}function m(e){for(var r=0;r<t.ignoreAttributePrefixes.length;r++){var n=t.ignoreAttributePrefixes[r]+e;return i[n]}}function h(){return o}function v(){return R}var R,g=this,k={},A={};!function(){"object"===(void 0===i?"undefined":_typeof(i))&&null!==i||(i={}),u(),a(),f(),l(),(0,_extendReadOnly2.default)(g,{$hasLink:s,$hasEmbedded:y,$has:b,$href:p,$meta:m,$link:_,$request:v,$response:h})}()}return n}Object.defineProperty(exports,"__esModule",{value:!0});var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};exports.default=ResourceFactory;var _extendReadOnly=require("../utility/extend-read-only"),_extendReadOnly2=_interopRequireDefault(_extendReadOnly),_defineReadOnly=require("../utility/define-read-only"),_defineReadOnly2=_interopRequireDefault(_defineReadOnly),_generateUrl=require("../utility/generate-url"),_generateUrl2=_interopRequireDefault(_generateUrl),_normalizeLink=require("../utility/normalize-link"),_normalizeLink2=_interopRequireDefault(_normalizeLink);ResourceFactory.$inject=["HalResourceClient","$halConfiguration","$log"];
...
"use strict";function resolveUrl(e,r){for(var t="",o=/^((?:\w+\:)?)((?:\/\/)?)([^\/]*)((?:\/.*)?)$/,l=o.exec(e),s=o.exec(r),u=1;u<5;u++)s[u]?t+=s[u]:t+=l[u];return t}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=resolveUrl;
